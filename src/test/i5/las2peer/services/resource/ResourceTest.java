 ...
 * 179 - Test Class
 *
 * This class provides a basic testing framework for the microservice 179. It was
...
public class ResourceTest {
  ...
  public void testgetT() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/todo", pa.toJSONString(),
        MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testgetT': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
